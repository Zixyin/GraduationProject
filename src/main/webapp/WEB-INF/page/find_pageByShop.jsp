...
$(document).ready(function(){
  ...
  $(".seachform2").fadeIn(200);
    ...
    <div class="formtitle"><span>货物列表</span></div>
	    ...
	    <ul class="seachform1">
	    <form id="search_form" action="find_countByShop" method="post">
		  	<li><label>仓库编号：</label><input name="shopid" type="text" class="scinput1" /></li>
		    <li><label>仓库名称：</label><input name="shopname" type="text" class="scinput1" /></li>
		  ...
		  laypage.render({
			  ...
			  ,jump: function(obj, first){
			    ...
			    //alert(obj.limit); //得到每页显示的条数	        
   			    $.post("find_contentByShop",{"pageSize":obj.limit,"pageNumber":obj.curr},function(data){
					var result = "";

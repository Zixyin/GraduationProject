...
$(document).ready(function(){
  ...
  $(".seachform2").fadeIn(200);
    ...
    <div class="formtitle"><span>货物列表</span></div>
	    ...
	    <ul class="seachform1">
	    <form id="search_form" action="find_pageCount" method="post">
		  	<li><label>商品名称：</label><input name="productname" type="text" class="scinput1" /></li>
		    <li><label>商品类别：</label><input name="category" type="text" class="scinput1" /></li>
		  ...
		  laypage.render({
			  ...
			  ,jump: function(obj, first){
			    ...
			    //alert(obj.limit); //得到每页显示的条数	        
   			    $.post("find_pageContent",{"pageSize":obj.limit,"pageNumber":obj.curr},function(data){
					var result = "";
					for(var i = 0;i < data.length;++ i){
						...
						result += "<td>" + data[i].unit +"</td>";
						result += "<td><a href=\"detail_product?id="+data[i].id+"\" class=\"tablelink\" >详细信息</a></td>";		 
						result += "</tr>";
					}
					$("tbody").html(result);
				}); 

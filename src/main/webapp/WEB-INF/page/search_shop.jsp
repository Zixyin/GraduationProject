...
$(document).ready(function(){
  ...
  $(".seachform2").fadeIn(200);
    ...
    <div class="formtitle"><span>仓库列表</span></div>
		  ...
		  laypage.render({
			  ...
			  ,jump: function(obj, first){
			    ...
			    //alert(obj.limit); //得到每页显示的条数	        
   			    $.post("shopContent",{"pageSize":obj.limit,"pageNumber":obj.curr},function(data){
					var result = "";
					for(var i = 0;i < data.length;++ i){
						...
						result += "<td><a href=\"detail_shop?id="+data[i].id+"\" class=\"tablelink\" >详情</a>&nbsp;";
	 					result += "<a href=\"delete_shop?id="+data[i].id+"\" class=\"tablelink\" onclick=\"return confirm('确认删除？');\">删除</a></td>";				 
						result += "</tr>";
					}
					$("tbody").html(result);
				}); 

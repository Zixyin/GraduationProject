		  ...
		  laypage.render({
			  ...
			  ,jump: function(obj, first){
			    ...
			    //alert(obj.limit); //得到每页显示的条数	        
   			    $.post("supplyinContent",{"pageSize":obj.limit,"pageNumber":obj.curr},function(data){
					var result = "";
					for(var i = 0;i < data.length;++ i){
						...
						result += "<td><a href=\"detail_supplyin?id="+data[i].id+"\" class=\"tablelink\" >详情</a>&nbsp;";
	 					result += "<a href=\"delete_supplyin?id="+data[i].id+"\" class=\"tablelink\" onclick=\"return confirm('确认删除？');\">删除</a></td>";				 
						result += "</tr>";
					}
					$("tbody").html(result);
				}); 

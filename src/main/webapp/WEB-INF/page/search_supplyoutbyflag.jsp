...
$(document).ready(function(){
  ...
  $(".seachform2").fadeIn(200);
    ...
    <div class="formtitle"><span>销售订单</span></div>
		  ...
		  laypage.render({
			  ...
			  ,jump: function(obj, first){
			    ...
			    //alert(obj.limit); //得到每页显示的条数	        
   			    $.post("supplyoutContentByFlag",{"pageSize":obj.limit,"pageNumber":obj.curr},function(data){
					var result = "";
					for(var i = 0;i < data.length;++ i){
						...
						result += "<td><a href=\"updStockForSale?id="+data[i].id+"\" class=\"tablelink\" >补货</a></td>";
						result += "</tr>";
					}
					$("tbody").html(result);
				}); 
